                            ...
                            <div class="block block-rounded mb-0">
                                <div class="block-header block-header-default">
                                    ...
                                    <div class="block-options">
                                        <a class="btn-block-option fs-sm" href="{{ route('root') }}">I have an account.</a>
                                    </div>
                                </div>
                                <div class="block-content">
                                    <div class="p-sm-0 px-md-1 px-md-5 py-md-1">
                                        <form class="js-validation-signin" method="post" action="{{ route('application.signup') }}">
                                            @csrf
                                        <div class="py-3">
                                            <div class="mb-4">
                                                <label class="form-label" style="color: snow !important;">Email Address</label>
                                                <input type="email" class="form-control form-control-alt form-control-lg" id="email" name="email" placeholder="Enter your phone number" required value="{{ old('email') }}">
                                            </div>
                                            <div class="mb-4">
                                                <label class="form-label" style="color: snow !important;">Phone Number</label>
                                                <input type="text" class="form-control form-control-alt form-control-lg" id="pnumber" name="pnumber" placeholder="Enter your phone number" required value="{{ old('pnumber') }}">
                                            </div>
                                            <div class="mb-4">
