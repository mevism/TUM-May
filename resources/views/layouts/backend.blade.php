...
{{--                <span class="nav-main-link-name">Admin Panel</span>--}}
            ...
            <li class="nav-main-item{{ request()->is('intakes/*') ? ' open' : '' }}">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('intakes/show') ? ' active' : '' }}" href="{{ url('showIntake') }}">
                    <span class="nav-main-link-name">View intakes</span>
                  </a>
                </li>
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('intakes/index') ? ' active' : '' }}" href="{{ url('addintake') }}">
              ...
              <li class="nav-main-item{{ request()->is('school/*') ? 'open' : '' }}">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link{{ request()->is('school/show') ? ' active' : '' }}" href="{{ url('showSchool') }}">
                              <span class="nav-main-link-name">View schools</span>
                          </a>
                      </li>
                      <li class="nav-main-item">
                          <a class="nav-main-link{{ request()->is('school/addschool') ? ' active' : '' }}" href="{{ url('addschool') }}">
              ...
              <li class="nav-main-item{{ request()->is('department/*') ? ' open' : '' }}">
                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link{{ request()->is('department/show') ? ' active' : '' }}" href="{{ url('showDept') }}">
                      <span class="nav-main-link-name">View department</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link{{ request()->is('department/adddept') ? ' active' : '' }}" href="{{ url('adddept') }}">
              ...
              <li class="nav-main-item{{ request()->is('courses/*') ? ' open' : '' }}">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link{{ request()->is('courses/show') ? ' active' : '' }}" href="{{ url('showCourse') }}">
                              <span class="nav-main-link-name">View courses</span>
                          </a>
                      </li>
                      <li class="nav-main-item">
                          <a class="nav-main-link{{ request()->is('courses/index') ? ' active' : '' }}" href="{{ url('addcourse') }}">
                              <span class="nav-main-link-name">Add courses</span>
                          </a>
                      </li>
                  </ul>
              </li>
              <li class="nav-main-item{{ request()->is('classes/*') ? ' open' : '' }}">
                  <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                      <i class="nav-main-link-icon si si-layers"></i>
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link{{ request()->is('classes/show') ? ' active' : '' }}" href="{{ url('showClasses') }}">
