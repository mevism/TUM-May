            ...
            <div class="col-md-8">
                ...
                <a class="block block-rounded block-link-shadow text-center" href="javascript:void(0)">
                    <div class="block-header">
                        <h3 class="block-title"><?php echo e($course->course_name); ?></h3>
                    </div>
                    <div class="block-content bg-body-light">
                        <div class="py-2">
                            <p class="h5 fw-bold mb-2"><?php echo e($course->course_requirements); ?></p>
                        </div>
                    </div>
                    <div class="block-content">
                        <div class="h4 fw-bold mb-2">Cluster Subjects </div>
                        <div class="fs-sm py-2">
                            <p>
                                <?php echo e($course->subject_1); ?>

                            </p>
                            <p>
                                <?php echo e($course->subject_2); ?>

                            </p>
                            <p>
                                <?php echo e($course->subject_3); ?>

                            </p>
                            <p>
                                <?php echo e($course->subject_4); ?>
