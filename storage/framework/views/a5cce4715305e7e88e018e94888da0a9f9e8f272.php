            ...
            <div class="block-content block-content-full">
              <div class="row">
                ...
                <div class="col-lg-8 space-y-0">
                   <form class="row row-cols-lg-auto g-3 align-items-center" action="<?php echo e(route('courses.storeCourse')); ?>" method="POST">
                    ...
                    <div class="col-12 col-xl-12">
                      <select name="campus" id="campus" value="<?php echo e(old('campus')); ?>" class="form-control form-control-alt text-uppercase">
                    ...
                    <div class="col-12 col-xl-12">
                      ...
                      <div class="col-12 col-xl-12">
                        <textarea value = "<?php echo e(old('course_requirements')); ?>" class = "form-control form-control-alt text-uppercase" id="course_requirements" name="course_requirements" placeholder="Course Requirements"></textarea>
                ...
                <div class="col-lg-4">                
                    ...
                    <div class="col-12 col-xl-12">
                      <input type="text" value="<?php echo e(old('subject3')); ?>" class="form-control form-control-alt text-uppercase" id="subject3" name="subject3" placeholder="subject3">
                    </div><br>
                    <div class="col-12 col-xl-12">
                      <input type="text"value="<?php echo e(old('subject4')); ?>" class="form-control form-control-alt text-uppercase" id="subject4" name="subject4" placeholder="subject4">
                    </div>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TUM\Modules/Courses\Resources/views/course/addCourse.blade.php ENDPATH**/ ?>